...
<form class="form-horizontal" method="POST">
    ...
    ?>
        ...
        <form action="config/pembayaranproses.php" method="POST">
            ...
            <label class="col-sm-7"><input class="form-control" name="nis" type="text" value="<?php echo $nis ?>" required></label>
          </div>
          <br>         
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <label class="col-sm-1">:</label>
            <label class="col-sm-7"><input class="form-control" name="nama_siswa" type="text" value="<?php echo $data['nama_siswa']; ?>" required></label>
          <div class="form-group">
          </div>
          <div class="form-group">
            <label class="col-sm-3">Kelas</label>
            <label class="col-sm-1">:</label>
            <label class="col-sm-7"><input class="form-control" name="kelas" type="text" value="<?php echo $data['kelas']; ?>" required></label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <label class="col-sm-1">:</label>
            <label class="col-sm-7"><input class="form-control" name="total" type="text" value="<?php echo $data['total_spp']; ?>" readonly></label>
          </div>
...
echo 'Tahun Ajaran '.$tahunajaran; ?>   
           ...
           <div class="table-responsive">
             <table class="table table-bordered" id="" width="100%" cellspacing="0" align="center">
              <thead>
                <tr align="center">
